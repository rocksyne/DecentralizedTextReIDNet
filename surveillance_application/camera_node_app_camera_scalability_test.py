...
if __name__ == "__main__":
    ...
    parser.add_argument('--no_images', type=int, required=True, help='Number of images to use for camera')
    args = parser.parse_args()

    camera_name = args.camera_name
    number_of_images = int(args.no_images)
        ...
        try:
            if subscriber_socket.poll(500):
                ...
                if len(message_parts) == 2:
                    ...
                    image_list = image_list[0:number_of_images]
