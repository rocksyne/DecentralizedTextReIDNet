...
class WebcamCapture:
    def __init__(self, src=0, configs: dict = None, resolution="VGA", frame_rate: int = 15):
        self.src = src
    ...
    def read(self):
        try:
            ...
            return self.ret, original, original_img_as_tensor, preprocessed
...
if __name__ == "__main__":
    ...
    try:
        ...
        cam = WebcamCapture(configs=configs)

        while True:
            ret, frame, _, _ = cam.read()
            if ret:
