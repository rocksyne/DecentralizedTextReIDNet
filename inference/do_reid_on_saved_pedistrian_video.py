...
def process_frames(camera, token_ids, orig_token_length):
    ...
    out = cv2.VideoWriter('output_video.mp4', fourcc, 10, (512, 512))
    frame_counter = 1
    while True:
        ...
        if persons_embeddings_out != None:
            ...
            filtered_boxes_with_scores = [(bbox, score) for bbox, score in zip(ranked_bbs, ranked_scores) if score >= 0.60]
