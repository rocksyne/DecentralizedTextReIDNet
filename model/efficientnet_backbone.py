...
class EfficientNetBackbone(nn.Module):
    def __init__(self, stages_to_extract_from:list[int]=[3,5,7,9])->list[torch.tensor]:
        """
        Doc.:   The visiual backbone. https://arxiv.org/pdf/1905.11946.pdf
                ...
                stages 3, 5, 7, and 9. We ignore 9
                Please see ../docs/efficientnet_B0_architecture.txt for the complete architecture
