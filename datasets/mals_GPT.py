...
class MALSDataset(Dataset):
    def __init__(self, 
        ...
        self.annot_file_path = "/home/users/roagyeman/research/DecentralizedTextReIDNet/scripts/captions.json"
    ...
    def _process_annotation(self) -> List[Tuple[int, str, str, str]]:
        ...
        for person_id, data in tqdm(enumerate(self.annotations), total=len(self.annotations)):
            ...
            img_path = os.path.join(self.image_directory, data['image_name'])
